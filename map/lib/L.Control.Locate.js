...
(function (factory, window) {
    ...
    var LocateControl = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            container.style.backgroundImage = "url('lib/images/marker.png')";
            ...
            this._link = L.DomUtil.create('img', 'leaflet-buttons-control-img', container);
            this._link.setAttribute('src','lib/images/marker.png');
            this._link.href = '#';
