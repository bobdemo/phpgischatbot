 <?php
/*!
 * PHP Polyline Encoder: from https://github.com/dyaaj/polyline-encoder/blob/master/PolylineEncoder.php
 * 
 * https://github.com/dyaaj/polyline-encoder/blob/master/README.md
 * 
 */
